...
\begin{theorem}{Formula di Standardizzazione}
	...
	\begin{esempio}[Esempio:]
		Ho distribuzione normale $X \sim$ N($10,4$) con media $\mu=10$ e varianza $\sigma^2=4$. \textcolor{red}{$P(X \leq 12)$=?} \\
		...
		\begin{enumerate}
			...
			\[
				P(Z \leq 1)=\phi(1)
			\]
			\item Guardo le tabelle della Distribuzione Normale Standard per trovare il valore:
		\end{enumerate}
	\end{esempio}
\end{theorem}
