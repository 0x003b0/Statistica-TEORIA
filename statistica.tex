	...
	\begin{esercizio}[Problema indiretto:]
		...
		\begin{itemize}
			\item \textcolor{red}{Tempo di installazione del software per cui il 90$\%$ dei tempi sono inferiori a tale tempo}
			      Trova il valore di $x$ dato p=0.9; Ovvero
			      trova il tempo (minuti) di istallazione per cui il 90$\%$ dei dati sono concentrati (no concentrati no...) sotto tale soglia (di minuti).
			      \begin{enumerate}
				      \item \textbf{Trova $z$:} \\
