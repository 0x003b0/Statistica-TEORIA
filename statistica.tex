...
\begin{esercizio}[Test unilaterale destro di una popolazione Normale con $\sigma^2$ ignota]

\end{esercizio}


\begin{esercizio}[Test unilaterale sinistro di una popolazione Normale con $\sigma^2$ ignota]
...
\begin{esercizio}[Test bilaterale di una popolazione Normale con $\sigma^2$ ignota]
