...
\begin{itemize}
	...
	\item \textbf{Combinazioni:} non uso tutti gli $n$ oggetti ma solo $r$ oggetti scelti dall'insieme dove $r<n$. Ordine non conta
\end{itemize}
...
& Uso \textbf{tutti} gli $n$ oggetti 
& $P_n = n!$ \\[8pt]

\hline
\textbf{Disposizioni} 
& \textcolor{green}{\scalebox{1.6}{\checkmark}} 
& Uso \textbf{$r$ oggetti su $n$} 
& $D(n,r) = \dfrac{n!}{(n-r)!}$ \\[8pt]

\hline
\textbf{Combinazioni} 
& \textcolor{red}{\scalebox{1.6}{\texttimes}} 
& Uso \textbf{$r$ oggetti su $n$} 
& $C(n,r) = \dfrac{n!}{r!(n-r)!}$ \\[8pt]
