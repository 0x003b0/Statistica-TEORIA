...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\begin{align*}
			\ell''(\theta)<0
		\end{align*}
		\item Se il parametro ignoto è più di uno, controllo che la derivata parziale seconda sia negativa con il test dell'Hessiana
	\end{itemize}
\end{enumerate}
\subsubsection{Metodi per valutare gli stimatori}
Ho trovato lo stimatore (non stima) per il parametro ignoto e devo valutare se questo è il candidato giusto verificando:
\begin{itemize}
