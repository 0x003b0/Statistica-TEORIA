...
\begin{enumerate}
	...
	\item \textcolor{red}{Definizione del valore critico $z_{1- \alpha/2}$ e della regione di rifiuto}
...
\begin{esercizio}[Esercizio 1]
	...
	\begin{align*}
		...
		\end{cases}
	\end{align*}
	con $\alpha=0.01$ e $\overline{x}=502.9$ con $n=40$ campioni. \textcolor{red}{Verificare l'ipotesi nulla $H_0$.}
	\begin{center}
		\textbf{Soluzione}
	\end{center}
	\begin{enumerate}
		\item Calcolare valore critico $z_{1-\alpha/2}$
		\begin{align*}
			z_{1- \alpha/2}=z_{1-0.01}=z_{0.995}=2.57
		\end{align*}
...
\begin{theorem}{$p-$value}
	IIl \textcolor{red}{$p-$value} è la probabilità che la statistica test assuma un valore uguale o più estremo (nella direzione dell'ipotesi alternativa) di quello
	osservato quando $H_0$ è vera.
\end{theorem}
