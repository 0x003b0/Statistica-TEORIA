...
\subsubsection{Come costruire gli intervalli di confidenza: Media}
\begin{theorem}{Stima Intervallare della Media con $\sigma^2$ nota}
	SSia:
	\begin{itemize}
	...
	\end{align*}
\end{theorem}
\begin{theorem}{Stima Intervallare della Media con $\sigma^2$ ignota}
	SSia:
	\begin{itemize}
		\item Popolazione Normale
	...
	\end{align*}
\end{theorem}
\subsubsection{Come costruire gli intervalli di confidenza: Varianza}
\begin{theorem}{Stima Intervallare della Varianza}
	SSia:
	\begin{itemize}
		\item Popolazione Normale
	\end{itemize}
	\begin{align*}
		\frac{(n-1)s^2}{\chi^2_{1- \frac{\alpha}{2}}} \textcolor{cyan}{\; < \sigma^2 < \;} \frac{(n-1)s^2}{\chi^2_{1- \frac{\alpha}{2}}}
	\end{align*}
	L'ampiezza intervallare $A$ si misura come segue:
\end{theorem}
\newpage
