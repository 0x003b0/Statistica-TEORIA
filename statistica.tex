...
Si usa quando interessa la prob. di successi ottenuti e devo ripetere lo stesso esperimento bernoulliano $n$ volte ognuno con probabilità di successo pari a $\theta$.\\
...
\begin{theorem}{$X \sim$ Binomiale($n;\theta$) }
	...
	\[
		\binom{n}{k} \cdot \theta^k \cdot (1-\theta)^{n-k}
	\]
\end{theorem}
\begin{osservazioni}[Osservazione]
	\[
