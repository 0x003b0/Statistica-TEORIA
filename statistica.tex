...
\begin{esercizio}[Esercizio]
	...
	Qual è la probabilità che \textbf{almeno una} delle 3 lettere sia inserita nella busta corrispondente?
	\begin{enumerate}
		...
		\end{enumerate}
	\end{enumerate}
	Dunque applico la formula di probabilità totale per $3$ eventi:
	\begin{align*}
	...
	\end{align*}
	\begin{itemize}
		\item $P(E_1)=\frac{\text{casi favorevoli}}{\text{casi possibili}}=\frac{?}{3!}$ \\
		...
		\begin{itemize}
			...
			\item $\cancel{321}$
		\end{itemize}
		\item $P(E_2)=\frac{\text{casi favorevoli}}{\text{casi possibili}}=\frac{?}{3!}$ \\
		Casi favorevoli che accada $P(E_2)$
		\item $P(E_3)=\frac{\text{casi favorevoli}}{\text{casi possibili}}=\frac{?}{3!}$ \\
		Casi favorevoli che accada $P(E_3)$
		\item $P(E_1 \cap E_2)$
		\item $P(E_1 \cap E_3)$
		\item $P(E_2 \cap E_2)$
		\item $P(E_1 \cap E_2 \cap E_3)$
	\end{itemize}
	Oppure posso utilizzare la negazione $P(E)=1-P(\overline{E})$:
	\begin{itemize}
	...
	\begin{align*}
		P(\overline{E})
		 ...
		 & = \frac{2}{3} \cdot \frac{3}{2} \cdot \frac{2}{3}=\frac{2}{3}
	\end{align*}
	\begin{itemize}
		...
		\end{enumerate}
		\item $P(\overline{E_2} \mid \overline{E_1})=\frac{\overline{E_2} \cap \overline{E_1}}{P(\overline{E_1})}=\frac{?}{\frac{1}{3}}=\frac{\frac{1}{2}}{\frac{1}{3}}=\frac{3}{2}$ \\
	...
	Pertanto:
	\[
	P(E)=1-P(\overline{E})=1-\frac{2}{3}=0.33
	\]
	Cos'ho sbagliato? deve venire 0.667 piu o meno
\end{esercizio}
