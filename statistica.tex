...
\begin{esempio}[Stimatore distorto]
	...
	\begin{align*}
		\mathbb{B} = \mathbb{E}[T_n(\vec{X})] - \lambda &=  \frac{n-1}{n}\lambda - \lambda \\
		&= - \frac{\lambda}{n}
	\end{align*}
	Nel caso avessi $n=5, \lambda=4$ allora la distorsione sarebbe:
	\begin{align*}
		\mathbb{B} = - \frac{\lambda}{n} =- \frac{4}{5} = -0.8
	\end{align*}
\end{esempio}
...
\begin{tabular}{cccc}
\toprule
\textbf{Modello per} & \textbf{Dimensione} & \textbf{Parametro} & \textbf{Migliore} \\
\textbf{la popolazione} & \textbf{del campione} & \textbf{da stimare} & \textbf{stimatore} \\
\midrule
$X \sim N(\mu, \sigma^2)$ & qualsiasi & $\mu$ & $\bar{X} = \frac{1}{n} \sum X_i$ \\
\addlinespace
$X \sim f(\mu, \sigma^2)$ & $n$ grande & $\mu$ & $\bar{X} = \frac{1}{n} \sum X_i$ \\
\addlinespace
$X \sim Ber(p)$ & $n$ grande & $p$ & $\hat{p} = \frac{1}{n} \sum X_i$ \\
\addlinespace
$X \sim \mathcal{P}(\lambda)$ & qualsiasi & $\lambda$ & $\bar{X} = \frac{1}{n} \sum X_i$ \\
\addlinespace
$X \sim N(\mu, \sigma^2)$ & qualsiasi & $\sigma^2$ & $\bar{S}^2 = \frac{1}{n-1} \sum (X_i - \bar{X})^2$ \\
\bottomrule
\end{tabular}
\end{table}
\newpage
