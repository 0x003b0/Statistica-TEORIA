...
\end{itemize}
\begin{esempio}[Esempio campionamento da popolazioni finite: Studio Salariale]
...
\end{esempio}
\begin{esempio}[Esempio campionamento da variabili aleatorie: Studio Componenti Elettronici]
...
\begin{itemize}
	...
	\begin{itemize}
		\item prima estrazione: $x_1 = 28.000$ € (Luigi)
		\item prima estrazione: $x_2 = 40.000$ € (Marco)
		\item $\cdots$
	\end{itemize}
	\item Studio Componeneti elettronici: la variabile aleatoria è $X = $ tempo di vita di un componente
\end{itemize}
