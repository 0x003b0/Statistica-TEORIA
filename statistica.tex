	...
	\begin{enumerate}
		...
		\item Registro la loro durata e risulta che:
		      \begin{align*}
			      ...
			      X_4 = 40   \\
		      \end{align*}
		      posso vedere che per $X_1,X_3$ risulta un successo (1), mentre per gli altri un insuccesso (0). Quindi la probabilità di osservare 
...
\subsubsection{Stimatore vs Stima}
