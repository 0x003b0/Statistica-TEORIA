...
Serve quando so la probabilità di un evento condizionato e voglio conoscere la probabilità di un evento singolo
\\
Tipo, conosco i valori di $P(T \mid M)=x$ e $P(\overline{T} \mid \overline{M})=y$ e voglio conoscere $P(T)=?$ 
